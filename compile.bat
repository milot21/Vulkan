C:\VulkanSDK\1.4.321.1\Bin\glslc.exe shaders\point_light.vert -o shaders\point_light.vert.spv
C:\VulkanSDK\1.4.321.1\Bin\glslc.exe shaders\point_light.frag -o shaders\point_light.frag.spv
